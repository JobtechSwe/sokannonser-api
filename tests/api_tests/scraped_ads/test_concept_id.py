...
# no hits for 'occupation-field' queries because ads don't have value in ['occupation_field']
@pytest.mark.parametrize("occupation, expected_ids", [
    (field.halso__och_sjukvard, [19769, 43643, 19764, 43645, 19765, 43655]),
    (field.hotell__restaurang__storhushall, [20208, 20352]),
    (field.transport, [12242]),
...
def test_occupation_field(session_scraped, scraped_url, occupation, expected_ids):
    ...
    json_response = get_scraped(session_scraped, scraped_url, params={'occupation-field': occupation, 'limit': '0'})
    actual_ids = get_actual_ad_ids(json_response)
    check_ids(actual_ids, expected_ids)
    assert json_response['total']['value'] == len(expected_ids)
...
@pytest.mark.parametrize("city, region, country, expected_ids", [
    (geo.stockholm, geo.stockholms_lan, geo.sverige,
     ['801', '2001', '2101', '2601', '8301', '8501', '10001', '11101', '11401', '12201', '12401', '13001', '13501', '16401', '18401', '18901', '19101', '19501', '20201', '21001', '21701', '22101', '24501', '25101', '25301', '25901', '26401', '27901', '28301', '29101', '29301', '29701', '29901', '30201', '30301', '30401', '30501', '30701', '31001', '31201', '33401', '33501', '35401', '36901', '37101', '41501', '42601', '43001', '43801', '45601']
),
    (geo.malmo, geo.skane_lan, geo.sverige,
     ['1701', '3401', '13401', '23701', '26901', '29801', '31601', '31901', '33101', '35201', '36501', '36601', '45401', '46101', '49701']),
...
@pytest.mark.parametrize("region, expected_cities, country, expected_ids", [
    ...
    (geo.skane_lan,
     ...
     ['601', '701', '1701', '2301', '3401', '6001', '9801', '10201', '12701', '13201', '13401', '13901', '15201', '16301', '17501', '17801', '19001', '21301', '22901', '23701', '24901', '26901', '29801', '31601', '31701', '31801', '31901', '32501', '33101', '35201', '36501', '36601', '42101', '42301', '44601', '45401', '45501', '46101', '46201', '46601', '46701', '47201', '47301', '47501', '47601', '48201', '48701', '49401', '49701']
    ...
    (geo.stockholms_lan,
     ...
     ['801', '1501', '2001', '2101', '2601', '3801', '3901', '5301', '5501', '6601', '7201', '7401', '7601', '7901', '8301', '8501', '9201', '9901', '10001', '10501', '10701', '11101', '11401', '12201', '12401', '13001', '13501', '16401', '18401', '18901', '19101', '19401', '19501', '20201', '21001', '21701', '22101', '24501', '25101', '25301', '25701', '25901', '26401', '27701', '27901', '28301', '29101', '29301', '29701', '29901', '30201', '30301', '30401', '30501', '30701', '30801', '30901', '31001', '31101', '31201', '32601', '32801', '33401', '33501', '35401', '35501', '36701', '36901', '37101', '41501', '42501', '42601', '43001', '43201', '43801', '44701', '44801', '45101', '45301', '45601', '49201']
),
])
def test_search_region(session_scraped, scraped_url, region, expected_cities, country, expected_ids):
    ...
    cities = set()
    for hit in hits:
        c = f"{hit['workplace_address']['municipality_concept_id']}   {hit['workplace_address']['municipality']}"
        cities.add(c)
    for city in cities:
        print(city)
...
@pytest.mark.parametrize("country, expected_number",
                         [(geo.sverige, 495), (geo.norge, 4), (geo.grekland, 1), (geo.schweiz, 0), (geo.estland, 0), (geo.stockholm, 0)])
