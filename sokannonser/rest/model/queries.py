...
swagger_doc_params = {
    ...
    settings.X_FEATURE_HISTORICAL_ADS: "Search historical ads instead of published ads",
...
base_annons_query.add_argument(settings.X_FEATURE_DISABLE_SMART_FREETEXT, type=inputs.boolean,
                               location='headers', required=False)
base_annons_query.add_argument(settings.X_FEATURE_HISTORICAL_ADS, type=inputs.boolean,
                               location='headers', required=False)
