...
# no hits for 'occupation-field' queries
@pytest.mark.parametrize("occupation, expected_ids", [
    (field.halso__och_sjukvard, [19769, 43643, 19764, 43645, 19765, 43655]),
    (field.hotell__restaurang__storhushall, [20208, 20352]),
    (field.transport, [12242]),
...
@pytest.mark.parametrize("city, region, country, expected_ids", [
    ...
    (geo.goteborg, geo.vastra_gotalands_lan, geo.sverige,
     ['3501', '3701', '11001', '11701', '16601', '23301', '25201', '26101', '28101', '32301', '40901', '50101',
      '50501']),
...
@pytest.mark.parametrize("region, expected_cities, country, expected_ids", [
    ...
    (geo.stockholms_lan,
     ...
     ['801', '1501', '2001', '2101', '2601', '3801', '3901', '5301', '5501', '6601', '7201', '7401', '7601', '7901',
      ...
      '44701', '44801', '45101', '45301', '45601', '49201', '50001', '50201', '50301']),
])
...
@pytest.mark.parametrize("country, expected_number",
                         [(geo.sverige, 505), (geo.norge, 4), (geo.grekland, 1), (geo.schweiz, 0), (geo.estland, 0), (geo.stockholm, 0)])
