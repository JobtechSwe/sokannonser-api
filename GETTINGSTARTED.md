...
In Sweden, organizations number reflect type of organization. For instance, the first number is 2 if the organisation is a public. This could be used in you search.
