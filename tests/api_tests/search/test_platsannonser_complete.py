...
@pytest.mark.parametrize("query, expected_suggestions", [
    ...
    ('gymnas',
     ['gymnasieutbildning', 'gymnasielärare', 'gymnasiekompetens', 'gymnasieexamen', 'gymnasium', 'gymnasieskola',
      'gymnastik', 'gymnasiebehörighet', 'gymnasieprogram', 'gymnasieskolekompetens']),
    ('gymnasie',
     ['gymnasieutbildning', 'gymnasielärare', 'gymnasiekompetens', 'gymnasieexamen', 'gymnasieskola',
      'gymnasiebehörighet', 'gymnasieprogram', 'gymnasieskolekompetens']),
